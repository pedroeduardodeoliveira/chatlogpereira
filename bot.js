...
server.listen(3112, () => console.log("🚀 Interface web http://localhost:3112/"));
...
io.on("connection", socket => {
    ...
    // Envia todo log armazenado (manter log mesmo após atualizar)
...
// Armazena o log globalmente para persistir após atualizar
let globalLogs = [];
